...
//===== 1 Question & 1 Answer =====
$query1 = mysqli_query("SELECT `id`, `english`, `lala_correct`, `lala_incorrect` FROM TOEFL_IS_600 WHERE `lala_correct` < 5 ORDER BY RAND() LIMIT 1");
$row1 = mysqli_fetch_array($query1);
$question = $row1[english];
$query11 = mysqli_query("SELECT `master_id`, `english`, `chinese` FROM pydict WHERE `english` = '$question'" );
...
$query2 = mysqli_query("SELECT `id`, `english` FROM `TOEFL_IS_600` ORDER BY RAND () LIMIT 1"); 

$query3 = mysqli_query("SELECT id, english FROM `TOEFL_IS_600` ORDER BY RAND () LIMIT 1"); 
