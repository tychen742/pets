...
$query3 = mysqli_query($con,"SELECT id, english, meaning FROM TOEFL_IS_600 ORDER BY RAND() LIMIT 1");
$query4 = mysqli_query($con,"SELECT id, english, meaning FROM TOEFL_IS_600 ORDER BY RAND() LIMIT 1");
...
<fieldset>
<legend>PEC Flashcard:</legend>
<p style="font-size:25px;"><?PHP echo $question ?>
</p>

<input type="hidden" name="theanswer" value="<?PHP echo $answer; ?>">
<input type="hidden" name="question" value="<?PHP echo $question; ?>">

<input  cols="20" type="submit" name="answer" value="<?PHP echo $arr[0] ?>"> </input> 
