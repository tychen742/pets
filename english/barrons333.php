...
if (!$query_tbl_result && $id != null) {
    ...
    if ($result_create_table != null) {
        ...
        $query_update_english = "UPDATE $score_table
				...
				SET $score_table.english = barrons333.english 
...
// ===== 1 Question & 1 Answer =====
$query1 = mysqli_query($conn_iss, "SELECT id, english, explanation FROM `barrons333` ORDER BY RAND() LIMIT 1");
$row1 = mysqli_fetch_array($query1);
$question = $row1 ['english'];
// echo $row1[id], $row1[english], $row1['explanation'];
...
<?PHP
// ===== 3 Answer Items =====//
$query2 = mysqli_query($conn_iss, "SELECT id, english, explanation FROM barrons333 ORDER BY RAND() LIMIT 1");
$query3 = mysqli_query($conn_iss, "SELECT id, english, explanation FROM barrons333 ORDER BY RAND() LIMIT 1");
$query4 = mysqli_query($conn_iss, "SELECT id, english, explanation FROM barrons333 ORDER BY RAND() LIMIT 1");
    ...
    <FORM style="color: white; background-color: grey; width: 450px;"
        ...
        <fieldset>
            ...
            <p>
                ...
                conn_iss, "UPDATE $score_table SET $score_table.dont_know = ($score_table.dont_know + 1) WHERE $score_table.english = 'theanswer' ");
