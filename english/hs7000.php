...
// if (session_status() == PHP_SESSION_NONE) {
    ...
    header("Location: http://cycuim.org/pec/login.php");
	}
...
//===== 1 Question & 1 Answer =====
$query1 = mysqli_query($conn_iss,"SELECT id, english, explanation FROM `moe_7000` ORDER BY RAND() LIMIT 1");
...
<?PHP
//===== 3 Answer Items =====//
$query2 = mysqli_query($conn_iss,"SELECT id, english, explanation FROM moe_7000 ORDER BY RAND() LIMIT 1");
$query3 = mysqli_query($conn_iss,"SELECT id, english, explanation FROM moe_7000 ORDER BY RAND() LIMIT 1");
$query4 = mysqli_query($conn_iss,"SELECT id, english, explanation FROM moe_7000 ORDER BY RAND() LIMIT 1");
