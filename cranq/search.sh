...
result=./results/results${dt}.list   ### create result file
result_archive=./results/archive_dependencies${dt}.list
...
#	    FOUND_COUNT_STR=$(( $FOUND_COUNT_STR + 	))
	...
	echo "  " FOUND ${FOUND_COUNT_R} dependencies in $R_FILE  >> $result
...
# echo '     ' FOUND $FOUND_COUNT_R results in  $FILE 
    ...
    echo  >> $result
    echo FOUND $FOUND_ARCHIVE_COUNT dependencies in $ARCHIVE_VER at $ARCHIVEDT >> $result

    echo FOUND $FOUND_ARCHIVE_COUNT dependencies in $ARCHIVE_VER at $ARCHIVEDT >> $result_archive
...
# echo Found $ARCHIVE_COUNT_TOTAL in the archives of $
