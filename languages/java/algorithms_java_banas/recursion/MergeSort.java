...
public class MergeSort {
	...
	public static void mergeSort_srt(int array[], int lo, int n) {
		...
		// Send the array, o and the middle index of the array
		mergeSort_srt(array, low, middle);

		// Send the array, the middle index + 1 and the highest index of the
		// array
		...
		// If the lowest index is less than or equal to the bottom array's
	...
	// Used to print out hte smaller arrays
